...
Make sure to copy the outputted S3 Bucket Name and the API Gateway URLs. You will need these for the subsequent steps.

### Step 2: Configure the Local Machine Learning Environment
...
3. Open `train_model.py` and update the `BUCKET_NAME` variable with the S3 bucket name generated by Terraform in Step 1.

### Step 3: Configure and Build the Mobile App
...
2. Install the Node dependencies:
   npm install
3. Open the main networking/configuration file in the React Native codebase and paste the API Gateway URLs generated in Step 1.
4. Launch the application on your emulator or connected physical device:
   npx react-native run-android 
   # or npx react-native run-ios

### Step 4: Operational Workflow (Testing the System)
